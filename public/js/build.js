...
/***/ function(module, exports, __webpack_require__) {
	...
	global.M = __webpack_require__(5);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function($) {exports.getNewsType = function( cb ) {
		$.ajax({
			type: "get",
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "D:\\webpack\\vuedemo\\src\\views\\index.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"page slideIn\">\n\t<div class=\"hd\"><h1 class=\"page_title\">新闻类型</h1></div>\n\t<div class=\"bd\">\n\t\t<div class=\"weui_cells weui_cells_access\">\n            <a class=\"weui_cell\" v-for=\"new in news\" v-link=\"{name:'newlist',params:{'tid':new.typeid}}\">\n                <div class=\"weui_cell_bd weui_cell_primary\">\n                    <p>{{new.typename}}</p>\n                </div>\n                <div class=\"weui_cell_ft\">{{new.newcount}}</div>\n            </a>\n        </div>\n\t</div>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "D:\\webpack\\vuedemo\\src\\views\\newlist.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
	...
	module.exports = {
		...
		route: {
			data: function data(transition) {
				...
				var that = this;
				M.getNewsByTid(tid, function (news) {
					that.news = news;
				});
			}
		}
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"page slideIn\">\n\t<div class=\"hd\"><h1 class=\"page_title\">XXX类型</h1></div>\n\t<div class=\"bd\">\n\t\t<div class=\"weui_cells weui_cells_access\">\n            <a class=\"weui_cell\" v-for=\"new in news\" v-link=\"{name:'newdetail',params:{'nid':new.nid}}\">\n                <div class=\"weui_cell_bd weui_cell_primary\">\n                    <p>{{new.ntitle}}</p>\n                </div>\n                <div class=\"weui_cell_ft\">{{new.addtime}}</div>\n            </a>\n        </div>\n\t</div>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src\\views\\newdetail.vue: named exports in *.vue files are ignored.")}
	...
	module.exports = {
		...
		route: {
			data: function data(transition) {
				...
				var that = this;
				M.getNewsByNid(nid, function (news) {
					that.news = news[0];
				});
			}
		}
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"page slideIn\">\n\t<div class=\"bd\">\n\t\t<div class=\"weui_article\">\n\t\t\t<h1 class=\"page_title\">{{news.ntitle}}</h1>\n\t\t\t<section>\n\t\t\t\t<p>{{{news.ncontent}}}</p>\n\t\t\t</section>\n\t\t</div>\n\t</div>\n</div>\n";
